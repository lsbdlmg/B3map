...
const create = (Objects, device, world, RAPIER) => {
  { //后侧墙壁玻璃 2层
    ...
    for (let i = 0; i < 8; i++) Glass.positionArray.push({ x: -42 - i * 9, y: 9.5, z: 104.6 })
    for (let i = 0; i < 6; i++) Glass.positionArray.push({ x: 19 - i * 9, y: 22, z: 104.6 })
    for (let i = 0; i < 8; i++) Glass.positionArray.push({ x: -42 - i * 9, y: 22, z: 104.6 })
  ...
  { //后侧墙壁玻璃 上下3层
    ...
    //-182-61-5*9=-
    //下侧长
    for (let i = 0; i < 6; i++) Glass.positionArray.push({ x: -121 - i * 9, y: 13, z: 104.6 })
    for (let i = 0; i < 6; i++) Glass.positionArray.push({ x: -182 - i * 9, y: 13, z: 104.6 })
    for (let i = 0; i < 6; i++) Glass.positionArray.push({ x: -182 - 61 - i * 9, y: 13, z: 104.6 })
    //上侧短
    for (let i = 0; i < 6; i++) Glass.positionArray.push({ x: -121 - i * 9, y: 22, z: 104.6 })
    for (let i = 0; i < 6; i++) Glass.positionArray.push({ x: -182 - i * 9, y: 22, z: 104.6 })
    for (let i = 0; i < 6; i++) Glass.positionArray.push({ x: -182 - 61 - i * 9, y: 22, z: 104.6 })
    //下侧短
    for (let i = 0; i < 6; i++) Glass.positionArray.push({ x: -121 - i * 9, y: 4, z: 104.6 })
    for (let i = 0; i < 6; i++) Glass.positionArray.push({ x: -182 - i * 9, y: 4, z: 104.6 })
    for (let i = 0; i < 6; i++) Glass.positionArray.push({ x: -182 - 61 - i * 9, y: 4, z: 104.6 })
    Glass.scaleArray = []
    //下侧长
