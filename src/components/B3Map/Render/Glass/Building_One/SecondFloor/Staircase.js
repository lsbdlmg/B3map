...
const create = (Objects, device, world, RAPIER) => {
  {
    ...
    Glass.positionArray = []
    //最下面一排
    // for (let i = 0; i < 3; i++) Glass.positionArray.push({ x: -111 - i * 11, y: 39.5, z: -13.4 })
    //上面连着三排
    for (let i = 0; i < 3; i++) Glass.positionArray.push({ x: -111 - i * 11, y: 56, z: -13.4 })
    for (let i = 0; i < 3; i++) Glass.positionArray.push({ x: -111 - i * 11, y: 65, z: -13.4 })
    for (let i = 0; i < 3; i++) Glass.positionArray.push({ x: -111 - i * 11, y: 74, z: -13.4 })
    //楼梯左侧
    // for (let i = 0; i < 2; i++) Glass.positionArray.push({ x: -138.5, y: 39.5, z: -8.9 + i * 9 })
    for (let i = 0; i < 2; i++) Glass.positionArray.push({ x: -138.5, y: 56, z: -8.9 + i * 9 })
    for (let i = 0; i < 2; i++) Glass.positionArray.push({ x: -138.5, y: 65, z: -8.9 + i * 9 })
    for (let i = 0; i < 2; i++) Glass.positionArray.push({ x: -138.5, y: 74, z: -8.9 + i * 9 })
