...
const create = (Objects, device, world, RAPIER) => {
  {
    ...
    Glass.positionArray.push({ x: -1072.5, y: 46, z: -265 })
    Glass.positionArray.push({ x: -1072.5, y: 46, z: -275 })

    // Window Group 2 (Near Inner/Wall 3)
    // Centers: -325, -335 (Between frames -320, -330, -340)
    Glass.positionArray.push({ x: -1072.5, y: 46, z: -325 })
    Glass.positionArray.push({ x: -1072.5, y: 46, z: -335 })
