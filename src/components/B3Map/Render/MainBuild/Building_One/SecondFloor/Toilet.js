...
const create = (Objects, device, world, RAPIER) => {
  {
    ...
    Wall.positionArray = [{ x: -139, y: 50, z: 5.1 + 31.75 }]
  ...
  }
  {
    ...
    const Wall = createCube({ hw: 1, hh: 1, hd: 1, slices: 20, repeat: { x: 0.2, y: 6, z: 9 } })
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [{ x: -208.5, y: 50, z: 36.85 }]
...

  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [
      { x: -184 - 1.5, y: 50, z: 28.6 },
      { x: -160 - 1.5, y: 50, z: 28.6 },
    ]
  ...
  }
  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [{ x: -166.5 - 1.5, y: 44.5, z: 51.1 }]
  ...
  }
  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [{ x: -172 - 1.5, y: 60.5, z: 51.1 }]
  ...
  }
  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [
      { x: -160 - 1.5, y: 60.5, z: 57.1 },
      { x: -184 - 1.5, y: 60.5, z: 57.1 },
    ]
  ...
  }
  {
    ...
    DoorFrame.positionArray = [
      //女厕 左右 上下
      { x: -160 - 1.5, y: 44, z: 62.1 },
      { x: -160 - 1.5, y: 44, z: 52.1 },
      { x: -160 - 1.5, y: 54.5, z: 57.1 },
      { x: -160 - 1.5, y: 34.05, z: 57.1 },
      //男厕
      { x: -184 - 1.5, y: 44, z: 62.1 },
      { x: -184 - 1.5, y: 44, z: 52.1 },
      { x: -184 - 1.5, y: 54.5, z: 57.1 },
      { x: -184 - 1.5, y: 34.05, z: 57.1 },
      //清洁间
      { x: -183 - 1.5, y: 44, z: 51.1 },
      { x: -173 - 1.5, y: 44, z: 51.1 },
      { x: -178 - 1.5, y: 54.5, z: 51.1 },
      { x: -178 - 1.5, y: 34.05, z: 51.1 },
    ]
  ...
  }
  {
    ...
    for (let i = 0; i < 6; i++) Pillar.positionArray.push({ x: -140.5 - i * 11, y: 47, z: 1.6 })
  ...
  }
  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [{ x: -173.5, y: 54.5, z: 2.7 }]

    Wall.rotationArray = [{ x: 0, y: 0, z: 0 }]
    Wall.scaleArray = [{ x: 34, y: 0.5, z: 4 }]
  ...
  }
  {
    ...
    const pillar = createGeometry(device, Pillar.vertices, Pillar.indices)
    Pillar.positionArray = [{ x: -172, y: 64, z: 2.1 }]
    Pillar.scaleArray = [{ x: 33, y: 4, z: 3.5 }]
  ...
  }
  {
    ...
    //外侧窗框 竖直
    for (let i = 0; i < 6; i++) WindowFrame.positionArray.push({ x: -140.5 - i * 11, y: 46, z: 5.1 })
    for (let i = 0; i < 6; i++) WindowFrame.scaleArray.push({ x: 0.5, y: 8, z: 0.5 })
    //外侧窗框 横向
    WindowFrame.positionArray.push({ x: -172, y: 53.5, z: 5.1 })
    WindowFrame.scaleArray.push({ x: 33, y: 0.5, z: 0.5 })
    WindowFrame.positionArray.push({ x: -172, y: 38.5, z: 5.1 })
    WindowFrame.scaleArray.push({ x: 33, y: 0.5, z: 0.5 })
