...
const MainHallMainRender = (
    ...
    const {
        ...
        CameraUniformBuffer: CameraUniformBuffer,//相机位置缓冲区
    } = BeforeRender
    // 主渲染
    {
        const renderPass = commandEncoder.beginRenderPass({
            ...
            depthStencilAttachment: {
                ...
                depthLoadOp: 'clear',//第一个渲染不需要保留之前的
                depthClearValue: 1.0,
        ...
        // 更新相机位置
        device.queue.writeBuffer(CameraUniformBuffer, 0, new Float32Array([eye.x, eye.y, eye.z, 0]))
