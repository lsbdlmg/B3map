...
import Building_Two_SecondFloor_FourthRoom from '@/components/B3Map/Render/MainBuild/Building_Two/SecondFloor/FourthRoom'
import Building_Two_SecondFloor_FifthRoom from '@/components/B3Map/Render/MainBuild/Building_Two/SecondFloor/FifthRoom'
import Building_Two_SecondFloor_Elevator from '@/components/B3Map/Render/MainBuild/Building_Two/SecondFloor/Elevator'
import Building_Two_SecondFloor_Staircase_Two from '@/components/B3Map/Render/MainBuild/Building_Two/SecondFloor/Staircase_Two'
import Building_Two_SecondFloor_Toilet from '@/components/B3Map/Render/MainBuild/Building_Two/SecondFloor/Toilet'
import Building_Two_SecondFloor_Staircase_One from '@/components/B3Map/Render/MainBuild/Building_Two/SecondFloor/Staircase_One'
import Building_Two_SecondFloor_CounselorOffice from '@/components/B3Map/Render/MainBuild/Building_Two/SecondFloor/CounselorOffice'
import Building_Two_SecondFloor_FirstRoom from '@/components/B3Map/Render/MainBuild/Building_Two/SecondFloor/FirstRoom'
import Building_Two_SecondFloor_SecondRoom from '@/components/B3Map/Render/MainBuild/Building_Two/SecondFloor/SecondRoom'

import Building_Two_ThirdFloor_Corridor from '@/components/B3Map/Render/MainBuild/Building_Two/ThirdFloor/Corridor'
...
const BeforeRender = async (device, format, world, RAPIER) => {
  ...
  const spotLightsData = []// 存放所有聚光灯数据的数组
  {
    ...
    }
    {
      ...
      Building_Two_SecondFloor_FourthRoom(Objects, device, world, RAPIER)
      Building_Two_SecondFloor_FifthRoom(Objects, device, world, RAPIER)
      Building_Two_SecondFloor_Elevator(Objects, device, world, RAPIER)
      Building_Two_SecondFloor_Staircase_Two(Objects, device, world, RAPIER)
      Building_Two_SecondFloor_Toilet(Objects, device, world, RAPIER)
      Building_Two_SecondFloor_Staircase_One(Objects, device, world, RAPIER)
      Building_Two_SecondFloor_CounselorOffice(Objects, device, world, RAPIER)
      Building_Two_SecondFloor_FirstRoom(Objects, device, world, RAPIER)
      Building_Two_SecondFloor_SecondRoom(Objects, device, world, RAPIER)
    }
    {
      Building_Two_ThirdFloor_Corridor(Objects, device, world, RAPIER)
    }
    // 放到最后 最后的灯不参与阴影计算
