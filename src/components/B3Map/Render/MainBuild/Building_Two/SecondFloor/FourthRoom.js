...
const create = (Objects, device, world, RAPIER) => {
  //前门
  {
    ...
    DoorFrame.positionArray = [
      //竖直
      { x: -922.5, y: 44, z: 94.4 - 65 },
      { x: -922.5, y: 44, z: 84.4 - 65 },
      { x: -922.5, y: 44, z: 83.3 - 65 },
      { x: -922.5, y: 44, z: 73.3 - 65 },
      //横向
      { x: -922.5, y: 54.5, z: 83.85 - 65 },
      { x: -922.5, y: 34.05, z: 83.85 - 65 },
    ]
  ...
  //后门
  {
    ...
    DoorFrame.positionArray = [
      //竖直
      { x: -922.5, y: 44, z: 94.4 - 280 },
      { x: -922.5, y: 44, z: 84.4 - 280 },
      { x: -922.5, y: 44, z: 83.3 - 280 },
      { x: -922.5, y: 44, z: 73.3 - 280 },
      //横向
      { x: -922.5, y: 54.5, z: 83.85 - 280 },
      { x: -922.5, y: 34.05, z: 83.85 - 280 },
    ]
  ...
  // 窗框
  {
    ...
    xPoints.forEach(x => {
      ...
      groups.forEach(startZ => {
        ...
        for (let i = 0; i < 7; i++) {
          WindowFrame.positionArray.push({ x: x, y: 46, z: startZ - i * 10 })
          WindowFrame.scaleArray.push({ x: 0.5, y: 7, z: 0.5 })
        }
        // 横向
        const centerZ = startZ - 30
        // Top
        WindowFrame.positionArray.push({ x: x, y: 53.5, z: centerZ })
        WindowFrame.scaleArray.push({ x: 0.5, y: 0.5, z: 30.5 })
        // Bottom
        WindowFrame.positionArray.push({ x: x, y: 38.5, z: centerZ })
        WindowFrame.scaleArray.push({ x: 0.5, y: 0.5, z: 30.5 })
      })
      ...
      for (let i = 0; i < 9; i++) {
        WindowFrame.positionArray.push({ x: x, y: 46, z: startZ_Other + i * 10 })
        WindowFrame.scaleArray.push({ x: 0.5, y: 7, z: 0.5 })
      }
      // Lateral for 8 windows (length 80)
      const centerZ_Other = startZ_Other + 40
      // Top
      WindowFrame.positionArray.push({ x: x, y: 53.5, z: centerZ_Other })
      WindowFrame.scaleArray.push({ x: 0.5, y: 0.5, z: 40.5 })
      // Bottom
      WindowFrame.positionArray.push({ x: x, y: 38.5, z: centerZ_Other })
      WindowFrame.scaleArray.push({ x: 0.5, y: 0.5, z: 40.5 })
    })
  ...
  // 窗户墙 (上下墙)
  {
    ...
    xPoints.forEach(x => {
      ...
      groups.forEach(z => {
        if (isOuter) {
          // Inner (-1072.25) 5.1
          Wall.positionArray.push({ x: x + 0.25, y: 60, z: z })
          Wall.scaleArray.push({ x: 0.25, y: 6, z: 30.5 })
          Wall.textureIndex.push(5.1)
          Wall.positionArray.push({ x: x + 0.25, y: 35, z: z })
          Wall.scaleArray.push({ x: 0.25, y: 3, z: 30.5 })
          Wall.textureIndex.push(5.1)
          // Outer (-1072.75) 4.1
          Wall.positionArray.push({ x: x - 0.25, y: 60, z: z })
          Wall.scaleArray.push({ x: 0.25, y: 6, z: 30.5 })
          ...
          // Normal
          Wall.positionArray.push({ x: x, y: 60, z: z })
          Wall.scaleArray.push({ x: 0.5, y: 6, z: 30.5 })
          Wall.textureIndex.push(5.1)
          Wall.positionArray.push({ x: x, y: 35, z: z })
          Wall.scaleArray.push({ x: 0.5, y: 3, z: 30.5 })
          Wall.textureIndex.push(5.1)
        }
      })
      ...
      if (isOuter) {
        // Inner
        Wall.positionArray.push({ x: x + 0.25, y: 60, z: centerZ_Other })
        Wall.scaleArray.push({ x: 0.25, y: 6, z: 40.5 })
        Wall.textureIndex.push(5.1)
        Wall.positionArray.push({ x: x + 0.25, y: 35, z: centerZ_Other })
        Wall.scaleArray.push({ x: 0.25, y: 3, z: 40.5 })
        Wall.textureIndex.push(5.1)
        // Outer
        Wall.positionArray.push({ x: x - 0.25, y: 60, z: centerZ_Other })
        Wall.scaleArray.push({ x: 0.25, y: 6, z: 40.5 })
        ...
        Wall.positionArray.push({ x: x, y: 60, z: centerZ_Other })
        Wall.scaleArray.push({ x: 0.5, y: 6, z: 40.5 })
        Wall.textureIndex.push(5.1)
        Wall.positionArray.push({ x: x, y: 36, z: centerZ_Other })
  ...
  // 间隔墙 (Pillars)
  {
    ...
    xPoints.forEach(x => {
      ...
      zPoints.forEach(z => {
        if (isOuter) {
          // Inner
          Pillar.positionArray.push({ x: x + 0.375, y: 49, z: z })
          Pillar.scaleArray.push({ x: 0.75, y: 17, z: 1.75 })
          ...
          Pillar.positionArray.push({ x: x, y: 49, z: z })
          Pillar.scaleArray.push({ x: 1.5, y: 17, z: 1.75 })
          Pillar.textureIndex.push(5.1)
        }
      })
    })
  ...
  // 后门另一侧墙体 (到走廊边缘) & 填补门口空缺 (x=-1072.5 only)
  {
    ...
    xPoints.forEach(x => {
      ...
      if (isOuter) {
        // Inner
        Wall.positionArray.push({ x: x + 0.25, y: 49, z: -215.35 + 4 })
        Wall.scaleArray.push({ x: 0.25, y: 17, z: 4.15 })
        Wall.textureIndex.push(5.1)
        // Outer
        Wall.positionArray.push({ x: x - 0.25, y: 49, z: -215.35 + 4 })
        Wall.scaleArray.push({ x: 0.25, y: 17, z: 4.15 })
        ...
        Wall.positionArray.push({ x: x, y: 49, z: -216 + 4.35 })
        Wall.scaleArray.push({ x: 0.5, y: 17, z: 4.35 })
        Wall.textureIndex.push(5.1)
      }
    })
    ...
    // Inner
    Wall.positionArray.push({ x: -1072.5 + 0.25, y: 49, z: 18.85 })
    Wall.scaleArray.push({ x: 0.25, y: 17, z: 10.55 })
    Wall.textureIndex.push(5.1)
    // Outer
    Wall.positionArray.push({ x: -1072.5 - 0.25, y: 49, z: 18.85 })
    Wall.scaleArray.push({ x: 0.25, y: 17, z: 10.55 })
    ...
    // Inner
    Wall.positionArray.push({ x: -1072.5 + 0.25, y: 49, z: -196.425 })
    Wall.scaleArray.push({ x: 0.25, y: 17, z: 10.775 })
    Wall.textureIndex.push(5.1)
    // Outer
    Wall.positionArray.push({ x: -1072.5 - 0.25, y: 49, z: -196.425 })
    Wall.scaleArray.push({ x: 0.25, y: 17, z: 10.775 })
  ...
  // 门上方墙体 (仅 -922.5)
  {
    ...
    Wall.positionArray = [
      // Front Door Top
      { x: -922.5, y: 60.5, z: 18.85 },
      // Back Door Top
      { x: -922.5, y: 60.5, z: -196.15 }
    ]
    Wall.scaleArray = [
      { x: 0.5, y: 5.5, z: 11.05 },
      { x: 0.5, y: 5.5, z: 11.05 }
  ...
  // 前后墙 (Front & Back Walls)
  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [
      { x: -997.5, y: 49, z: 112.9 },  // Front Wall
      { x: -997.4, y: 49, z: 115.7 },  // Front Wall
      { x: -997, y: 49, z: -216.5 }  // Back Wall
    ]
    Wall.scaleArray = [
      { x: 74.5, y: 17, z: 0.5 },
      { x: 75.6, y: 17, z: 2.3 },
  ...
  // 天花板
  {
    ...
    Ceiling.positionArray = [{ x: -997.5, y: 66, z: -51 }]
