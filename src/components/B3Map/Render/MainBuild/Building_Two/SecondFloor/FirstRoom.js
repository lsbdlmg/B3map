    ...
    //桌子
    {
      for (let i = 0; i < 3; i++) {
        createTable({
          ...
          RAPIER: RAPIER,
          TableAttribute: {
            position: { x: -620 + 40, y: 42, z: -30 - i * 50 },
            length: 35,
            width: 18,
            height: 8,
            topTextureIndex: 103,
    ...
    //椅子
    {
      for (let i = 0; i < 9; i++) {
        createChair({
          ...
          RAPIER: RAPIER,
          ChairAttribute: {
            position: { x: -620 + 52, y: 34 + 5, z: -17 - i * 13 - Math.floor(i / 3) * 11 },
          },
        })
        {
          createChair({
            ...
            RAPIER: RAPIER,
            ChairAttribute: {
              position: { x: -620 + 28, y: 34 + 5, z: -17 - i * 13 - Math.floor(i / 3) * 11 },
            }
          })
        }
        {
          createChair({
            ...
            RAPIER: RAPIER,
            ChairAttribute: {
              position: { x: -620 + 7, y: 34 + 5, z: -17 - i * 13 - Math.floor(i / 3) * 11 },
            }
          })
        }
        {
          createChair({
            ...
            RAPIER: RAPIER,
            ChairAttribute: {
              position: { x: -620 -17, y: 34 + 5, z: -17 - i * 13 - Math.floor(i / 3) * 11 },
            }
          })
        }
      }
