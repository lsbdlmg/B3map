...
const create = (Objects, device, world, RAPIER) => {
  ...
  }
  {
    ...
    DoorFrame.positionArray = [
      ...
      { x: -710, y: 10, z: -265.5 },
      //横
      { x: -710, y: 20.5, z: -259.5 },
      { x: -710, y: 0.05, z: -259.5 },
      //男厕
      //竖直
      { x: -734, y: 10, z: -253.5 },
      { x: -734, y: 10, z: -265.5 },
      //横
      { x: -734, y: 20.5, z: -259.5 },
      { x: -734, y: 0.05, z: -259.5 },
    ]
  ...
  }
  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [
      { x: -710, y: 26.5, z: -259.5 },
      { x: -734, y: 26.5, z: -259.5 },
    ]
    Wall.rotationArray = [
      { x: 0, y: 0, z: 0 },
      { x: 0, y: 0, z: 0 },
  ...
  }
  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [
      { x: -693.25, y: 16, z: -394.25 },
      { x: -691.75, y: 16, z: -394.75 }
    ]
    Wall.scaleArray = [
      { x: 2.25, y: 8, z: 0.25 },
      { x: 3.75, y: 8, z: 0.25 }
  ...
  }
  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [
      { x: -750.75, y: 16, z: -394.25 },
      { x: -752.25, y: 16, z: -394.75 }
    ]
    Wall.scaleArray = [
      { x: 2.25, y: 8, z: 0.25 },
      { x: 3.75, y: 8, z: 0.25 }
  ...
  }
  {
    ...
    Ceiling.positionArray = [{ x: -722, y: 32, z: -323 }]
    Ceiling.scaleArray = [{ x: 33.5, y: 2, z: 71 }]
