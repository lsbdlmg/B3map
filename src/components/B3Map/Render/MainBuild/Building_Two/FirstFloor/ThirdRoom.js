...
const create = (Objects, device, world, RAPIER) => {
  {
    ...
    Ceiling.positionArray = [{ x: -602, y: 32, z: -323.5 }]
    Ceiling.scaleArray = [{ x: 49, y: 2, z: 70.5 }]
  ...
  }
  {
    ...
    Wall.positionArray = [
      { x: -601.5, y: 16, z: -394.25 },
      { x: -602.5, y: 16, z: -394.75 },
    ]
    Wall.scaleArray = [
      { x: 47.5, y: 16, z: 0.25 },
      { x: 49.5, y: 16, z: 0.25 },
  ...
  }
  {
    ...
    DoorFrame.positionArray = [
      ...
      { x: -650.5, y: 10, z: -269 },
      //横
      { x: -650.5, y: 20.5, z: -263 },
      { x: -650.5, y: 0.05, z: -263 },
    ]
  ...
  }
  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [{ x: -650.5, y: 26.5, z: -263 }]
  ...
  }
  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [{ x: -650.5, y: 16, z: -332 }]
    Wall.rotationArray = [{ x: 0, y: 0, z: 0 }]
  ...
  }
  {
    ...
    //竖直
    for (let i = 0; i < 7; i++) WindowFrame.positionArray.push({ x: -553.5, y: 12, z: -257.5 - i * 10 })
    for (let i = 0; i < 7; i++) WindowFrame.positionArray.push({ x: -553.5, y: 12, z: -326.5 - i * 10 })
    for (let i = 0; i < 7; i++) WindowFrame.scaleArray.push({ x: 0.5, y: 7, z: 0.5 })
    for (let i = 0; i < 7; i++) WindowFrame.scaleArray.push({ x: 0.5, y: 7, z: 0.5 })
    // //横向
    //6块一侧
    WindowFrame.positionArray.push({ x: -553.5, y: 19.5, z: -287.5 })
    WindowFrame.scaleArray.push({ x: 0.5, y: 0.5, z: 30.5 })

    WindowFrame.positionArray.push({ x: -553.5, y: 4.5, z: -287.5 })
    WindowFrame.scaleArray.push({ x: 0.5, y: 0.5, z: 30.5 })
    //6块一侧
    WindowFrame.positionArray.push({ x: -553.5, y: 19.5, z: -356.5 })
    WindowFrame.scaleArray.push({ x: 0.5, y: 0.5, z: 30.5 })

    WindowFrame.positionArray.push({ x: -553.5, y: 4.5, z: -356.5 })
    WindowFrame.scaleArray.push({ x: 0.5, y: 0.5, z: 30.5 })
  ...
  }
  {
    ...
    for (let i = 0; i < 5; i++) Pillar.positionArray.push({ x: -550, y: 13, z: -267.5 - i * 10 })
    for (let i = 0; i < 5; i++) Pillar.positionArray.push({ x: -550, y: 13, z: -336.5 - i * 10 })
  ...
  }
  {
    ...
    const pillar = createGeometry(device, Pillar.vertices, Pillar.indices)
    Pillar.positionArray = [
      { x: -550, y: 20.5, z: -287.5 },
      { x: -550, y: 20.5, z: -356.5 }
    ]
    Pillar.scaleArray = [
      { x: 2.9, y: 0.5, z: 30.5 },
      { x: 2.9, y: 0.5, z: 30.5 }
  ...
  }
  {
    ...
    const pillar = createGeometry(device, Pillar.vertices, Pillar.indices)
    Pillar.positionArray = [
      { x: -550, y: 30, z: -188 - 69 * 2 },
      { x: -553.5, y: 30, z: -188 - 69 * 2 + 0.5 }
    ]
    Pillar.scaleArray = [
      { x: 3, y: 4, z: 69 },
      { x: 0.5, y: 4, z: 68.5 }
  ...
  }
  {
    ...
    const wall = createGeometry(device, Wall.vertices, Wall.indices)
    Wall.positionArray = [
      { x: -553.5, y: 23, z: -287.5 },
      { x: -553.5, y: 23, z: -356.5 },
      { x: -553.5, y: 2, z: -287.5 },
      { x: -553.5, y: 2, z: -356.5 },
    ]
    Wall.scaleArray = [
