...
const MainHallMainRender = (
  ...
  const {
    ...
    sun: sun,
    //缓冲区
    ObjectMatrixBuffer: ObjectMatrixBuffer, //物体VP矩阵缓冲区
    //绑定组
...

  {
    ...
    device.queue.writeBuffer(ObjectMatrixBuffer, 0, vpMatrix)
    device.queue.writeBuffer(ObjectMatrixBuffer, 64, Model)
